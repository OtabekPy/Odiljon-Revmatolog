    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bemor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainApp.bemor')),
            ],
        ),
        migrations.CreateModel(
            name='Tolov',
            fields=[
                ...
                ('bemor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mainApp.bemor')),
            ],
        ),
        migrations.CreateModel(
            name='Joylashtirish',
